...
<head>
    ...
    <style>
        ...
        .tipo-resultado-inferior {
            margin-left: 3em; /* Define a margem de recuo */
            display: inline-block; /* Mantém o bloco alinhado à esquerda */
            text-indent: -3em; /* Move a primeira linha para alinhar com a margem */
...
<table>
    ...
    <?php while ($row = $result->fetch_assoc()) : ?>
        <tr>
            ...
            <td>
                <?php
                // Exibe os tipos de resultado inferior com numeracao e texto com recuo alinhado
                ...
                foreach ($tipos_resultado_inferior as $tipo_resultado) {
                    ...
                    echo '<div><span class="numeracao"><a href="detalhes.php?numeracao_tipo_resultado=' . urlencode($numeracao) . '" target="_blank">' . htmlspecialchars($numeracao) . '</a></span><span class="tipo-resultado-inferior">' . htmlspecialchars($nome) . '</span></div>';
                }
                ?>
            </td>
