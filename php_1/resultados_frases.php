...
<table>
    ...
    <?php while ($row = $result->fetch_assoc()) : ?>
        <tr>
            ...
            <td>
                <?php 
                // Exibe os tipos de resultado inferior como links
                ...
                foreach ($tipos_resultado_inferior as $tipo_resultado) {
                    ...
                    echo '<a href="detalhes.php?numeracao_tipo_resultado=' . urlencode($numeracao) . '" target="_blank">' . htmlspecialchars($numeracao) . '</a> ' . htmlspecialchars($nome) . '<br>';
                }
                ?>
            </td>
