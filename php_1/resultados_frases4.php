...
<head>
    ...
    <style>
        ...
        .nome {
            flex-grow: 1;
            padding-left: 8px; /* Recuo constante para o texto */
        }
        a {
            color: #00bcd4;
...
<table>
    ...
    <?php while ($row = $result->fetch_assoc()) : ?>
        <tr>
            ...
            <td>
                <?php
                // Exibe os tipos de resultado inferior com numeracao e texto
                ...
                foreach ($tipos_resultado_inferior as $tipo_resultado) {
                    ...
                    echo '<span class="numeracao"><a href="detalhes.php?numeracao_tipo_resultado=' . urlencode($numeracao) . '" target="_blank">' . htmlspecialchars($numeracao) . '</a></span>';
