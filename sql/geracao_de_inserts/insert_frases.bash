...

{
    ...
    print "INSERT INTO tipos_acoes (nome_tipo_acao, id_tipo_resultado, id_tipo_elemento_sintatico) VALUES (\"" hash_unico_sem_caracteres_especiais "\", (SELECT id_chave_tipo_resultado FROM tipos_resultados WHERE numeracao_tipo_resultado = \"" $16 "\"), (SELECT id_chave_tipo_elemento_sintatico FROM tipos_elementos_sintaticos WHERE nome_tipo_elemento_sintatico = \"entrega no passado\"));\n" 
