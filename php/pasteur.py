...
import matplotlib.pyplot as plt  #novo meu
import time
import schedule  #novo meu
from PIL import Image #novo meu
import piexif  #novo meu
import subprocess  #novo meu
import imghdr  #novo meu
#from nudenet import NudeDetector

import argparse  #antigo incluido
import json      #antigo incluido
...
# Diretórios de criptografia windows
## source_dir = "../imagem/input"
## dest_dir = "../imagem/crypt"
## key_dir = "../imagem/key"

# Diretórios de criptografia  linux
source_dir = "../imagem/input"
dest_dir = "../imagem/crypt"
key_dir = "../imagem/key"

##encrypted_dir = '../imagem/crypt_quar'  # Onde as imagens criptografadas serão armazenadas windows
##keys_dir = '../imagem/decrypt_quar'  # Onde as chaves de descriptografia serão armazenadas windows

encrypted_dir = "../imagem/crypt_quar"  # Onde as imagens criptografadas serão armazenadas linux
keys_dir = "../imagem/decrypt_quar" # Onde as chaves de descriptografia serão armazenadas linux
...
def rodar_imagens():
    ...
    novo_nome_arquivo = None  # valor inicial
    a = 0 # variável global
    # pastas criadas windows
    ...
    # Diretórios de origem e destino da lixeira, diretorio da imagem windows
    #origem = '../imagem/input'
    ...
    # Diretórios de origem e destino da lixeira, diretorio da imagem linux
    origem = '../imagem/input'
    destino = '../imagem/lixeira'
    diretorio = '../imagem/input'
    input_dir = "../imagem/input"
    ...
    end_time = time.time()
    # After processing images, create a JSON output  "a" = numero de pessoas
    if novo_nome_arquivo is not None:
        ...
        print("Nenhum arquivo foi renomeado, variável 'novo_nome_arquivo' não definida.")
