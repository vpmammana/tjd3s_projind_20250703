            ...
            <tbody>
                ...
                foreach ($results as $row): 
                    if ($last_numeracao2 !== $row['numeracao2'] || $last_numeracao1 !== $row['numeracao1']): ?>
                        <tr>
                            <td colspan="2"><strong><?= htmlspecialchars($row['numeracao2'] . ' - ' . $row['nome_tipo_resultado1']) ?> <br> <?= htmlspecialchars($row['numeracao1'] . ' - ' . $row['nome_tipo_resultado2']) ?></strong></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td></td>
                        <td style="text-align: right;"><?= htmlspecialchars($row['tokens']) ?></td>
                    </tr>
                <?php 
