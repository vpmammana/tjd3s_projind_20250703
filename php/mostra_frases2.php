                ...
                foreach ($results as $row): 
                    if ($last_numeracao2 !== $row['numeracao2']): ?>
                        <tr>
                            ...
                            <td colspan="4"><strong>Tipo Resultado 2 mudou</strong>: <?= htmlspecialchars($row['nome_tipo_resultado1']) ?></td>
                        </tr>
                    <?php endif;
                    if ($last_numeracao1 !== $row['numeracao1']): ?>
                        <tr>
                            ...
                            <td colspan="3"><strong>Tipo Resultado 1 mudou</strong>: <?= htmlspecialchars($row['nome_tipo_resultado2']) ?></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td><?= htmlspecialchars($row['numeracao2']) ?></td>
