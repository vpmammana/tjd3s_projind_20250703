...
try {
    $query = "SELECT 
                GROUP_CONCAT(DISTINCT tr2.numeracao_tipo_resultado) AS numeracao1, 
                GROUP_CONCAT(DISTINCT tr1.numeracao_tipo_resultado) AS numeracao2, 
                GROUP_CONCAT(DISTINCT tr1.nome_tipo_resultado) AS nome_tipo_resultado1, 
                GROUP_CONCAT(DISTINCT tr2.nome_tipo_resultado) AS nome_tipo_resultado2, 
              ...
              ORDER BY numeracao1, numeracao2";
